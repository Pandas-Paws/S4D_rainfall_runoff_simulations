...
class CamelsTXT(Dataset):
    ...
    def __init__(self,
        ...
        self.x, self.y, self.q_std = self._load_data()
    ...
    def __getitem__(self, idx: int):
        if self.with_attributes:
            if self.concat_static:
                ...
                return x, self.y[idx], self.q_std
            else:
                return self.x[idx], self.attributes, self.y[idx], self.q_std
        else:
            return self.x[idx], self.y[idx], self.q_std
